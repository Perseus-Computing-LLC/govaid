...
Google Gemini for proposal generation, Perseus for live context grounding, and Perseus Vault
...
4. **Track** — Perseus Vault-backed persistent memory for deadlines, status, history
...
| Memory | Perseus Vault (persistent memory MCP) |
